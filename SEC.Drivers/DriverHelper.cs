...
namespace SEC.Drivers
{
    ...
    public static class DriverHelper
    {
        ...
        /// <returns></returns>
        public static OperateResult<bool[]> ReadBoole(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<ushort[]> ReadUshort(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<short[]> ReadShort(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<uint[]> ReadUint(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<int[]> ReadInt(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<float[]> ReadFloat(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<double[]> ReadDouble(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<long[]> ReadLong(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<ulong[]> ReadUlong(this IBaseDriver driver, string startAddress, ushort length = 1)
        {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public static OperateResult<string[]> ReadString(this IBaseDriver driver, string startAddress, ushort strLength, Encoding encoding, ushort length = 1)
        {
        ...
        /// <returns></returns>
        public static OperateResult<bool> WriteObject(this IBaseDriver driver, string startAddress, object obj, Encoding? encoding = null)
        {
            try
            {
                byte[]? bytes = null;
