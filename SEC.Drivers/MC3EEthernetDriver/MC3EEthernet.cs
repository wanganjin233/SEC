...
using SEC.Drivers.MC3EEthernetDriver;
using System.Text.RegularExpressions;

namespace SEC.Drivers 
{
    public class MC3EEthernet : BaseTCPDriver, IBaseDriver
    {
        public MC3EEthernet(string ServerIP, int serverPort) :
        ...
        public Dictionary<string, List<TagValue>> AddressTransition(List<TagValue> tagValues)
        {
